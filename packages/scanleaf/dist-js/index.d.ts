...
export type BarcodeFormat = 'QR_CODE' | 'EAN_13' | 'EAN_8' | 'UPC_A' | 'UPC_E' | 'CODE_39' | 'CODE_93' | 'CODE_128' | 'CODABAR' | 'ITF' | 'AZTEC' | 'DATA_MATRIX' | 'PDF_417';
/**
 ...
 */
export type BarcodeValueType = 'text' | 'url' | 'email' | 'phone' | 'sms' | 'wifi' | 'geo' | 'contact' | 'calendar' | 'isbn' | 'product' | 'driver-license' | 'unknown';
 ...
 */
export declare function openCamera(options?: CameraOptions): Promise<void>;
/**
 * Close the camera preview and release all camera resources.
 */
export declare function closeCamera(): Promise<void>;
/**
 ...
 */
export declare function startScan(options?: ScanOptions): Promise<void>;
/**
 ...
 * unlisten()
 */
export declare function onDetection(handler: (frame: ScanFrame) => void): Promise<UnlistenFn>;
/**
