<template>
  ...
  >
    ...
    <div class="flex-1 flex justify-center">
      <NuxtLinkLocale :to="{ path: leftTabs[0].path }" @dragstart.prevent>
        <button
          class="flex flex-col items-center p-1 cursor-pointer"
          :class="{
            'text-accent': activeTab === leftTabs[0].path,
            'text-base-content': activeTab !== leftTabs[0].path,
          }"
        >
          <svg
          ...
          <span class="text-sm">{{ leftTabs[0].label }}</span>
        </button>
      </NuxtLinkLocale>
    </div>
    <div class="flex-1 flex justify-center">
      <NuxtLinkLocale :to="{ path: leftTabs[1].path }" @dragstart.prevent>
        <button
          class="flex flex-col items-center p-1 cursor-pointer"
          :class="{
            'text-accent': activeTab === leftTabs[1].path,
            'text-base-content': activeTab !== leftTabs[1].path,
          }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="text-sm">{{ leftTabs[1].label }}</span>
        </button>
      </NuxtLinkLocale>
    </div>
    ...
    <div class="inset-x-0 top-0 -translate-y-1/4 px-3">
      ...
      >
        <Button
          class="w-16 h-16 rounded-full p-0 border-0 shadow-[0_0px_10px_rgba(0,0,0,0.25)] shadow-neutral-500 dark:shadow-neutral-900"
        >
          <svg
            class="w-6! h-6!"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Right Tabs -->
    <div class="flex-1 flex justify-center">
      <NuxtLinkLocale :to="{ path: rightTabs[0].path }" @dragstart.prevent>
        <button
          class="flex flex-col items-center p-1 cursor-pointer"
          :class="{
            'text-accent': activeTab === rightTabs[0].path,
            'text-base-content': activeTab !== rightTabs[0].path,
          }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="text-sm">{{ rightTabs[0].label }}</span>
        </button>
      </NuxtLinkLocale>
    </div>
    <div class="flex-1 flex justify-center">
      <NuxtLinkLocale :to="{ path: rightTabs[1].path }" @dragstart.prevent>
        <button
          class="flex flex-col items-center p-1 cursor-pointer"
          :class="{
            'text-accent': activeTab === rightTabs[1].path,
            'text-base-content': activeTab !== rightTabs[1].path,
          }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="text-sm">{{ rightTabs[1].label }}</span>
        </button>
      </NuxtLinkLocale>
    </div>
  </div>
