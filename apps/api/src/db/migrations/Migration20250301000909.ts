...
export class Migration20250301000909 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create index "category_tree_descendant_id_length_index" on "category_tree" ("descendant_id", "length");`);
    this.addSql(`create index "category_tree_ancestor_id_descendant_id_length_index" on "category_tree" ("ancestor_id", "descendant_id", "length");`);
    ...
    this.addSql(`create index "material_tree_descendant_id_length_index" on "material_tree" ("descendant_id", "length");`);
    this.addSql(`create index "material_tree_ancestor_id_descendant_id_length_index" on "material_tree" ("ancestor_id", "descendant_id", "length");`);
